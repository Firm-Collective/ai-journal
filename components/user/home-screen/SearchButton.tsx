  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        ...
        >
          <Text style={activeFilter === 'Tags' && styles.activeFilterText}>
            Tags ⌄
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text style={activeFilter === 'Date' && styles.activeFilterText}>
            Date ⌄
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text style={activeFilter === 'Media' && styles.activeFilterText}>
            Media ⌄
          </Text>
        </TouchableOpacity>
      </View>
