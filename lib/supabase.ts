...
const supabaseUrl =
  ...
  'https://udvardvrnqppvvvfqaac.supabase.co';
const supabaseAnonKey = process.env.EXPO_PUBLIC_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVkdmFyZHZybnFwcHZ2dmZxYWFjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTkwMDg0NTYsImV4cCI6MjAzNDU4NDQ1Nn0.EuY_I4seWBcAScl_vlOS6THNgAw77VmZKO6phv9qUt0';
